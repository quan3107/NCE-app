-- File: backend/src/prisma/migrations/20260801170000_preserve_equal_upload_policy_cas/migration.sql
-- Purpose: Validate equal-value upload-policy writes through the privileged boundary.
-- Why: Runtime callers lack the UPDATE privilege required for direct row locks.
...
BEGIN
  ...
  IF p_expected_max_file_size = p_max_file_size THEN
    PERFORM 1
