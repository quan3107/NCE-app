...
export async function postUserInvite(req: Request, res: Response): Promise<void> {
  const actor = requireActor(req, res)
  if (!actor) {
    return
  }
...
export async function postTeacherApproval(req: Request, res: Response): Promise<void> {
  const actor = requireActor(req, res)
  if (!actor) {
    return
  }
...
export async function postTeacherRejection(req: Request, res: Response): Promise<void> {
  const actor = requireActor(req, res)
  if (!actor) {
    return
  }
