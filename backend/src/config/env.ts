...
import { auditLabelSchema } from "../modules/audit-logs/contracts/common.js";
...
const envSchema = z
  .object({
    ...
    AI_MAX_OUTPUT_TOKENS: z.coerce.number().int().positive().default(4_096),
    AI_HEALTH_PATH: z.string().trim().default("/models"),
    AI_LOW_COST_MODEL: auditLabelSchema.default("gpt-5.6-luna"),
    ...
    AI_PREMIUM_MODEL: auditLabelSchema.default("gpt-5.6-luna"),
