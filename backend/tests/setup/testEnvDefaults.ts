...
export function applyBackendTestEnvDefaults(): void {
  ...
  process.env.AI_LOCAL_BASE_URL ??= 'http://localhost:11434/v1'
  process.env.AI_LOCAL_API_KEY = ''
  process.env.AI_LOCAL_MODEL ??= 'llama3.1'
  process.env.AI_LOCAL_REASONING_EFFORT ??= 'none'
  process.env.AI_LOCAL_SUPPORTS_REASONING_EFFORT ??= 'false'
