...
export const refreshStatsMutate = vi.fn();
export const refreshStatsState = {
  isPending: false,
  isError: false,
  isSuccess: false,
};
...
const contentFor = (pageKey: string) =>
  pageKey === 'contact'
    ? {
...
export const useSaveCmsDraftMutation = () => ({
  mutate: saveMutate,
  reset: saveReset,
  isPending: false,
  error: cmsState.saveError,
});
export const usePublishCmsDraftMutation = () => ({
  mutate: publishMutate,
  reset: publishReset,
  isPending: false,
  error: cmsState.publishError,
});
export const useRollbackCmsRevisionMutation = () => ({
...
export function resetCmsComponentState() {
  Object.assign(refreshStatsState, {
    isPending: false,
    isError: false,
    isSuccess: false,
  });
