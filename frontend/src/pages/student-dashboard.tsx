...
import { mockAssignments, mockSubmissions, mockEnrollments, mockCourses } from '../lib/mock-data';
import { Clock, FileText, CheckCircle2, AlertCircle, TrendingUp } from 'lucide-react';
