          ...
          <>
            ...
            <section className="space-y-4">
              <div className="grid gap-4 md:grid-cols-4">
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Input id="nce-unit-id" value={unitId} onChange={(event) => setUnitId(event.target.value)} />
                </div>
              ...
              <div className="space-y-2">
                ...
                <Input id="nce-title" value={title} onChange={(event) => setTitle(event.target.value)} />
              </div>
              <div className="space-y-2">
            ...
            <section className="space-y-3">
              <div className="flex items-center justify-between gap-3">
                ...
                <Button type="button" variant="outline" onClick={() => setObjectives((items) => [...items, emptyObjective(items.length)])}>
              ...
              {objectives.map((objective, index) => (
                <NceObjectiveEditor
                  ...
                  onRemove={() => setObjectives((items) => items.filter((_, itemIndex) => itemIndex !== index))}
                />
              ))}
            </section>
            ...
            <section className="space-y-3">
              <div className="flex items-center justify-between gap-3">
                ...
                <Button type="button" variant="outline" onClick={() => setExercises((items) => [...items, emptyExercise(items.length)])}>
                  <Plus className="mr-2 size-4" />
                  Add Exercise
                </Button>
              </div>
              {exercises.map((exercise, index) => (
                <NceExerciseEditor
                  ...
                  onRemove={() => setExercises((items) => items.filter((_, itemIndex) => itemIndex !== index))}
                />
              ))}
            </section>
