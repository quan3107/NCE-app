...
- **2026-09-20:** Verified public CMS and session behavior against the actual API and a separate disposable PostgreSQL database. Real transport failure, database-lock failure, published-only reads, empty course data, and restoration were checked; no backend application changes. SHELL-04 passes; X-02 retains an explicit full-route coverage limit. Evidence: `docs/e2e-public-recovery-verification.md`.
